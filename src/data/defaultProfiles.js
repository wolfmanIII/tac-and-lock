...
export const DEFAULT_PROFILES = [
...

  {
    ...
    software: ['manoeuvre', 'evade_1', 'stutterwarp_control'],
...

  {
    ...
    software: ['manoeuvre', 'evade_1', 'auto_repair_1', 'stutterwarp_control'],
    criticalTracks: blankCriticalTracks(),
    crew: [],
    crewAssignments: blankCrew(),
...

  {
    ...
    software: ['manoeuvre', 'fire_control_2', 'evade_2', 'auto_repair_1'],
    criticalTracks: blankCriticalTracks(),
    crew: [],
    crewAssignments: blankCrew(),
...

  {
    ...
    software: ['manoeuvre', 'fire_control_2', 'evade_1'],
    criticalTracks: blankCriticalTracks(),
    crew: [],
    crewAssignments: blankCrew(),
...

  {
    ...
    software: ['manoeuvre', 'fire_control_2', 'evade_1', 'auto_repair_1', 'stutterwarp_control'],
    criticalTracks: blankCriticalTracks(),
    crew: [],
    crewAssignments: blankCrew(),
...

  {
    ...
    software: ['manoeuvre', 'fire_control_1', 'stutterwarp_control'],
    criticalTracks: blankCriticalTracks(),
    crew: [],
    crewAssignments: blankCrew(),
