...
export const SHIP_CATALOG = [
  ...
  entry({
    ...
    weapons: [
      { weaponId: 'autocannon_25mm',  count: 1, label: '25mm Rotary AC (Retractable nose turret)', targetingSystem: 'light_tta' },
  ...
  entry({
    ...
    weapons: [
      { weaponId: 'ea1000', count: 2, label: 'Twin EA1000 w/UTES (Fixed retractable)', targetingSystem: 'utes' },
    ],
  ...
  entry({
    ...
    weapons: [
      { weaponId: 'll98',             count: 1, label: 'LL98 w/UTES (Surface retractable)', targetingSystem: 'utes' },
  ...
  entry({
    ...
    computer:   { model: 'Computer/20', bandwidth: 20 },
    weapons: [
      { weaponId: 'll98',              count: 2, label: 'Twin LL98 w/UTES (Surface retractable)', targetingSystem: 'utes' },
      { weaponId: 'autocannon_25mm',   count: 2, label: '25mm Rotary AC ×2 (Retractable)', targetingSystem: 'light_tta' },
      { weaponId: 'aero12',            count: 10, label: 'Aero-12 Missile ×10 (Internal bay)', targetingSystem: 'light_tta' },
  ...
  entry({
    ...
    computer:   { model: 'Computer/15', bandwidth: 15 },
    weapons: [
      { weaponId: 'grumbler',   count: 1, label: "Grumbler w/KUTS (Surface retractable)", targetingSystem: 'utes' },
      { weaponId: 'kingfisher', count: 10, label: 'Kingfisher Missile ×10 (Retractable)', targetingSystem: 'light_tta' },
