  ...
  return (
    <div className="p-6 space-y-5" style={{ minWidth: 480, maxWidth: 600 }}>
      ...
      <div className="grid grid-cols-3 gap-3 text-xs font-mono">
        ...
        <div>
          <p className="text-[10px] font-display text-slate-500 tracking-widest">EVASION</p>
          <p className="text-slate-200">{ship.evasionSpent ?? 0} spent</p>
        </div>
      </div>
      ...
      {crits.length > 0 && (
        <div>
          <p className="text-[10px] font-display text-slate-500 tracking-widest mb-1">CRITICAL HITS</p>
