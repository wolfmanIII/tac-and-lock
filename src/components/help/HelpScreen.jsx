    ...
    <div className="w-full h-full flex bg-gunmetal-950 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-6 space-y-10">
        ...
        <Section id="actions" title="Crew Actions">
          ...
          <Sub title="CAPTAIN">
            <KV k="Commands" v="Routine (8+) Leadership (INT or SOC). Order one crew role. Effect 1–4 → DM+1, Effect 5–6 → DM+2 to their actions this round. Cap = the Captain's own action budget. Applies immediately — the Captain acts first, so a Command issued early in the ship's turn is available to that role's later actions this same round. Crew Discipline: mark a role as having disobeyed instead — DM−1, no check, doesn't consume the Leadership cap." />
