      ...
      <main className="flex-1 overflow-y-auto px-8 py-6 space-y-10">
        ...
        <Section id="setup" title="Setup Phase">
          ...
          <Sub title="CONTEXT MENU GATING">
            ...
            <KV k="Launch Missiles…" v="Attack phase · current actor only." />
        ...
        {/* MISSILES */}
        <Section id="missiles" title="Missiles">
          <Sub title="LAUNCHING">
            <p>Right-click attacker → <span className="text-slate-200">Launch Missiles…</span> Select target and salvo size (1–6). The salvo enters the Missile Tracker with estimated rounds to impact. Each round it advances one band closer.</p>
          </Sub>

          <Sub title="COUNTERMEASURES">
            <Table
              headers={['Method', 'Phase', 'Effect']}
              rows={[
          ...
          <Sub title="IMPACT RESOLUTION">
            <p>When a salvo arrives, a <span className="text-slate-200">⚡ MISSILE IMPACT</span> modal opens. Roll attack (2D vs 8+). On hit, roll weapon damage − target Armour.</p>
          </Sub>
        </Section>
